...
import 'package:transaksi2/widgets/order_detail_widgets/curved_detail_header_clipper.dart';
import 'package:transaksi2/widgets/order_detail_widgets/detail_screen_header.dart'; // Menggunakan header alternatif
import 'package:transaksi2/widgets/order_detail_widgets/plastik_info_card.dart';
import 'package:transaksi2/widgets/order_detail_widgets/weight_selector_widget.dart';
import 'package:transaksi2/widgets/order_detail_widgets/photo_upload_widget.dart';
import 'package:transaksi2/widgets/order_detail_widgets/schedule_section_widget.dart';
import 'package:transaksi2/widgets/order_detail_widgets/delivery_info_widget.dart';
import 'package:transaksi2/widgets/order_detail_widgets/order_summary_details_widget.dart';
...
class _OrderDetailDropOffScreenState extends State<OrderDetailDropOffScreen> {
  ...
  final TextEditingController _waktuPengirimanController = TextEditingController();
  final TextEditingController _tanggalPengirimanController = TextEditingController();
  final TextEditingController _noTelpController = TextEditingController();
  final TextEditingController _alamatPengirimanController = TextEditingController();
        ...
        children: [
          ...
          SafeArea(
            child: Column(
              ...
              children: [
                const DetailScreenHeader(title: 'Order Detail'), // Menggunakan widget header kustom
                Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        const PlastikInfoCard(
                          imageUrl: 'assets/plastic-bottles.jpg', // Pastikan path aset benar
                        ),
                        ...
                        ScheduleSectionWidget(
                          ...
                          timeFieldHint: 'Masukkan Tanggal Pengiriman dd/mm/yyyy', // Sesuai gambar
                          timeController: _waktuPengirimanController,
                          onTimeTap: () => _selectTime(context, _waktuPengirimanController),
                          dateFieldLabel: 'Tanggal Pengiriman',
                          dateFieldHint: 'Masukkan Waktu Pengiriman dd/mm/yyyy', // Sesuai gambar
                          dateController: _tanggalPengirimanController,
                          onDateTap: () => _selectDate(context, _tanggalPengirimanController),
                        ),
                        const SizedBox(height: 24),
                        DeliveryInfoWidget(
